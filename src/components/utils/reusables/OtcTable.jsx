  ...
  return (
    <>
      <table className="min-w-full">
        ...
        <tbody>
          <tr>
            <td className="px-4 py-7 text-lg">OTCQX International1</td>
            <td className="px-4 py-7 w-[30rem] text-lg">
              Companies already listed on an international exchange (Not penny
              stocks, shell company, or in bankruptcy).
            </td>
            <td className="px-4 py-2 w-[30rem] text-lg">
              Asset requirements; Current regulatory disclosures.
            </td>
          </tr>
          <tr className="bg-gray-50">
            <td className="px-4 py-7 w-[30rem] text-lg">OTCQX U.S.</td>
            <td className="px-4 py-7 w-[30rem] text-lg">
          ...
          <tr>
            <td className="px-4 py-7 w-[30rem] text-lg">OTCQB</td>
            <td className="px-4 py-7 w-[30rem] text-lg">
          ...
          <tr className="bg-gray-50">
            <td className="px-4 py-7 w-[30rem] text-lg">OTC Pink</td>
            <td className="px-4 py-7 w-[30rem] text-lg">
