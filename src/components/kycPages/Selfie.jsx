    ...
    >
      ...
      <div className="w-full h-[calc(100%-60px)] flex">
        ...
        <div className="w-full pl-[50px] flex flex-col gap-[5px] pt-[30px]">
          ...
          <div className="flex flex-col justify-around border border-[#8E0789] w-full h-[calc(100%-45px)] rounded-[8px] bg-[#AA8EA8] px-[30px] pt-[15px]">
            <div className="w-full h-[70%] bg-[#413640] rounded-[8px] flex justify-center items-center">
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
