...
const OptionsPage = () => {
  ...
  return (
    <div>
      ...
      <div className="my-0 mx-auto mt-16 w-[90%] rounded-[0.8rem] overflow-hidden max-sm:w-[100%]">
        <table className="w-full h-[20rem] text-center  border border-solid border-gray-300 rounded-lg">
          <tr className="bg-[#0D86FF] h-16">
            ...
            <th className="text-white text-[1.3rem] font-medium max-sm:text-[1rem]">To Close</th>
          </tr>
          <tr>
          ...
          <tr>
            <td className="text-[#2B3240]">
              <p className="text-[1.3rem] max-sm:text-[1rem]">20 Iron Condors</p>{' '}
              <span> four legs</span>
            </td>
            <td>
              <span
      ...
      <div className="bg-[#0D86FF] h-[15rem]  items-center flex justify-around mt-20 max-md:flex-wrap max-lg:h-[25rem] max-lg:flex-col max-md:h-auto max-md:px-4 max-md:py-5 ">
        ...
        <div className="flex justify-between items-center gap-32 max-md:flex-col max-md:items-center max-md:gap-5 max-lg:p-2">
          ...
          <button className="flex gap-3 mt-5  cursor-pointer h-16 text-2xl
           text-blue-500 bg-white text-center font-open-sans-semibold 
      ...
      <div className="flex  justify-around items-center   max-lg:flex-col max-sm:justify-center max-sm:items-center">
        ...
        <img src={phoneScreen} className="w-[42rem] h-[40rem] max-sm:w-[50rem] max-sm:h-[40rem]" alt="" />
      </div>
