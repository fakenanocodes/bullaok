  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center gap-6">
        ...
        <button className="flex items-center text-[#550952] lg:p-4 px-5 py-2 lg:px-0 lg:py-0 rounded-xl font-bold mt-6 ">
          {' '}
          <span> Get in touch today!</span>{' '}
          <BsArrowRight style={{ color: '#550952' }} />
        </button>
      </div>
      <div className="flex gap-6 justify-center items-center w-full lg:flex-row flex-col lg:w-2/4">
